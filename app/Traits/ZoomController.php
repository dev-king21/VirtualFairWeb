...
trait ZoomController
{
    public static function get_users(Request $request) {

    }

    public static function all_users(Request $request) {
        $user = Zoom::user()->all();

    }
    
    public static function meeting_users(Request $request) {
    ...
    public static function create_webinar(Request $request) {
        // {
        //     "topic": "Test Webinar",
        //     "type": 5,
    ...
    public static function add_registrant() {
        // {
