...
var render = function() {
  ...
  return _c("div", { staticClass: "flex w-full breadcrumb justify-between" }, [
    _c(
      "div",
      { staticClass: "flex flex-row nav-item" },
      [
        _c("nav-back-button", {
          directives: [
            {
        ...
        _c(
          ...
          [
            _vm.type !== "svg"
              ? [
                  _c("feather-icon", {
                    attrs: { svgClasses: "w-12 h-12", icon: _vm.icon }
                  })
                ]
              : [
                  _c("svg-icon", {
                    attrs: { size: "w-12 h-12", icon: _vm.icon }
                  })
                ],
            _vm._v(" "),
            _c("div", { staticClass: "ml-4 fs-16 font-bold" }, [
    ...
    _vm.avatar || _vm.second
      ? _c(
          "div",
          {
            staticClass: "flex flex-row w-full text-white items-center py-3",
            class: {
              "justify-center": _vm.second_center,
              "justify-end": !_vm.second_center
            }
          },
          [
            _vm.avartar
                  ...
                  _vm.second_type !== "svg"
                    ? [
                        _c("feather-icon", {
                          attrs: {
                            svgClasses: "w-8 h-8",
                            icon: _vm.second_icon
                          }
                        })
                      ]
                    : [
                        _c("svg-icon", {
                          attrs: { size: "w-8 h-8", icon: _vm.second_icon }
                        })
                      ],
                  _vm._v(" "),
                  _c("div", { staticClass: "mx-4" }, [
                    _c("div", { staticClass: "user-name fs-16 text-white" }, [
                      _vm._v(_vm._s(_vm.second_text))
                    ])
                  ])
                ]
              : _vm._e()
