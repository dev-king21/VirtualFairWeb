          ...
          !_vm.loggedIn
                    ...
                    !_vm.logInClicked
                      ...
                      : [
                          _c("div", { staticClass: "login-form" }, [
                            _c("div", { staticClass: "h4 text-white" }, [
                              _vm._v(
            ...
            : [
                  ...
                  _c(
                    ...
                    [
                      _c("div", { staticClass: "text-white" }, [
                        _c(
                          "div",
                          { staticClass: "live-panel text-center" },
                          [
                            _c("feather-icon", {
                              attrs: {
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "flex w-full justify-between items-end home-footer px-10 main-btns"
                  },
                  [
                    _c("mfc-button", {
                      attrs: {
                    ...
                    _vm._v(" "),
                    _c("mfc-button", {
                      attrs: { icon: "ListIcon", text: "webinars" }
                    }),
                    _vm._v(" "),
                    _c("mfc-button", {
                      attrs: { icon: "ListIcon", text: "sostenibilidad" }
                    }),
                    _vm._v(" "),
                    _c("mfc-button", {
                      attrs: { icon: "ListIcon", text: "patrocinadores" }
                    })
                  ],
                  1
                )
