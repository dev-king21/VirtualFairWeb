  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        {
          staticClass:
            "flex w-full flex-col setting-stand-bg-img items-center justify-between bg-white-grey"
        },
        [
          _c("div", { staticClass: "flex" }, [_c("nav-back-button")], 1),
          _vm._v(" "),
          _c("div", { staticClass: "w-full h-full px-10 py-10" })
        ]
      )
    ],
    1
