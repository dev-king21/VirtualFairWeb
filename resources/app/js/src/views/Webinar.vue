  ...
  <div class="w-full">
    ...
    <div class="flex justify-end home-weinar-bg-img home-webinar-main">
        <div class="w-3/4 p-10">
            <div class="webinar-title text-white font-bold my-6">{{$t('ReserveWebinar')}}</div>
                ...
                <div class="vx-row flex flex-col justify-between w-3/5">
                    <div class="font-bold">
                        <div class="vx-row mt-10 fs-11">
                            ...
                            <div class="vx-col w-2/5">
                                ...
                                <div class="flex items-end">
                                    ...
                                    <div class="ml-2">{{webinar.room.name}}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="fs-11">
                            ...
                            {{webinar.exhibitor_profession}}<!-- Graduago de la Universidad de Barcelona. Cuenta con una Licenciatura en Mercadeo 4.0 -->
                        </div>
                        <h4 class="font-bold my-4">
                            {{webinar.title}}
                            <!--Desarrollo de estrategias virtuales para desarrollo de marcas -->
                        </h4>
                        <div class="font-bold font-italic mb-2">{{$t('GeneralInfo')}}:</div>
