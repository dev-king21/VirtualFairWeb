...
export default {
  pages: {
    ...
    data: [
      ...
      // PAGES
      {title: "Login Page",                url: "/auth/login",                        icon: "LockIcon",           is_bookmarked: false},
      {title: "Register Page",             url: "/auth/register",                     icon: "UserPlusIcon",       is_bookmarked: false},
      {title: "Forgot Password Page",      url: "/auth/forgot-password",              icon: "HelpCircleIcon",     is_bookmarked: false},
      {title: "Reset Password Page",       url: "/auth/reset-password",               icon: "UnlockIcon",         is_bookmarked: false},
      {title: "Lock Screen Page",          url: "/auth/lock-screen",                  icon: "LockIcon",           is_bookmarked: false},
      ...
      {title: "Not Authorized Page",       url: "/auth/not-authorized",               icon: "XCircleIcon",        is_bookmarked: false},
