<template>
  <span class="feather-icon-badge" :class="color">
    ...
    <template v-else-if="this.$props.icon==='download'">
      <svg xmlns="http://www.w3.org/2000/svg" :class="size" fill="currentColor" viewBox="0 0 60.1 58.1" style="enable-background:new 0 0 60.1 58.1;">
        <g>
          <g>
            <path d="M10.1,37.6v11.6h40l0-11.5c0-1.4,1-2.7,2.4-3c2-0.4,3.7,1.1,3.7,3v12c0,3.1-2.5,5.7-5.7,5.7H7.2    C5.4,55.2,4,53.8,4,52l0-15.2c0-0.5,0.2-1,0.6-1.3C7.1,33.3,10.1,35.1,10.1,37.6z"/>
            <path d="M32.1,38.5l12.4-12.4c1.2-1.2,1.2-3.1,0-4.3c-1.2-1.2-3.1-1.2-4.3,0L33.1,29l0-23.1c0-1.4-1-2.7-2.4-3    c-2-0.4-3.7,1.1-3.7,3v23.4l-7.3-7.3c-0.9-0.9-2.5-1.2-3.6-0.6c-1.1,0.6-1.6,1.6-1.6,2.7c0,0.8,0.3,1.6,0.9,2.1l12.4,12.4    c0.6,0.6,1.3,0.9,2.1,0.9C30.7,39.4,31.5,39.1,32.1,38.5z"/>
          </g>
        </g>
      </svg>
    </template>
    <template v-else-if="this.$props.icon==='profession'">
      <svg xmlns="http://www.w3.org/2000/svg" :class="size" fill="currentColor"  viewBox="0 0 20.7 22.7" style="enable-background:new 0 0 20.7 22.7;" xml:space="preserve">
        <g>
          <g>
            <path d="M18.8,15.8h-0.1c0.3-0.4,0.5-0.9,0.5-1.3c0-1.2-1-2.2-2.2-2.2c-1.2,0-2.2,1-2.2,2.2c0,0.5,0.2,1,0.5,1.3h-0.1
              c-0.5,0-0.9,0.4-0.9,0.9v2.7c0,0.7,0.5,1.2,1.2,1.2h3c0.7,0,1.2-0.5,1.2-1.2v-2.7C19.7,16.2,19.3,15.8,18.8,15.8z M15.6,14.4
              c0-0.7,0.6-1.3,1.3-1.3s1.3,0.6,1.3,1.3c0,0.7-0.6,1.3-1.3,1.3S15.6,15.2,15.6,14.4z M18.9,19.4c0,0.2-0.2,0.4-0.4,0.4h-3
              c-0.2,0-0.4-0.2-0.4-0.4v-2.7c0,0,0-0.1,0.1-0.1h3.6c0.1,0,0.1,0,0.1,0.1L18.9,19.4L18.9,19.4z"/>
          </g>
          <g>
            <path d="M5.6,15.8H5.5C5.8,15.4,6,14.9,6,14.4c0-1.2-1-2.2-2.2-2.2s-2.2,1-2.2,2.2c0,0.5,0.2,1,0.5,1.3H2
              c-0.5,0-0.9,0.4-0.9,0.9v2.7c0,0.7,0.5,1.2,1.2,1.2h3c0.7,0,1.2-0.5,1.2-1.2v-2.7C6.5,16.2,6.1,15.8,5.6,15.8z M2.4,14.4
              c0-0.7,0.6-1.3,1.3-1.3s1.3,0.6,1.3,1.3c0,0.7-0.6,1.3-1.3,1.3S2.4,15.2,2.4,14.4z M5.7,19.4c0,0.2-0.2,0.4-0.4,0.4h-3
              c-0.2,0-0.4-0.2-0.4-0.4v-2.7c0,0,0-0.1,0.1-0.1h3.6c0.1,0,0.1,0,0.1,0.1L5.7,19.4L5.7,19.4z"/>
          </g>
          <g>
            <path d="M16.7,11.4H4c-0.7,0-1.2-0.5-1.2-1.2V3.3c0-0.7,0.5-1.2,1.2-1.2h12.6c0.7,0,1.2,0.5,1.2,1.2v6.9
              C17.9,10.9,17.4,11.4,16.7,11.4z M4,2.9C3.8,2.9,3.6,3,3.6,3.3v6.9c0,0.2,0.2,0.4,0.4,0.4h12.6c0.2,0,0.4-0.2,0.4-0.4V3.3
              c0-0.2-0.2-0.4-0.4-0.4H4z"/>
          </g>
          <g>
            <path d="M10.4,9.8c-1.7,0-3.1-1.4-3.1-3.1s1.4-3.1,3.1-3.1s3.1,1.4,3.1,3.1S12,9.8,10.4,9.8z M10.4,4.5
              c-1.2,0-2.2,1-2.2,2.2S9.1,9,10.4,9s2.2-1,2.2-2.2S11.6,4.5,10.4,4.5z"/>
          </g>
          <g>
            <path d="M11,7.2h-0.6C10.1,7.2,10,7,10,6.8V5.2c0-0.2,0.2-0.4,0.4-0.4s0.4,0.2,0.4,0.4v1.1H11c0.2,0,0.4,0.2,0.4,0.4
              C11.4,7,11.2,7.2,11,7.2z"/>
          </g>
          <g>
            <path d="M12.2,15.8h-0.1c0.3-0.4,0.5-0.9,0.5-1.3c0-1.2-1-2.2-2.2-2.2s-2.2,1-2.2,2.2c0,0.5,0.2,1,0.5,1.3H8.6
              c-0.5,0-0.9,0.4-0.9,0.9v2.7c0,0.7,0.5,1.2,1.2,1.2h3c0.7,0,1.2-0.5,1.2-1.2v-2.7C13.1,16.2,12.7,15.8,12.2,15.8z M9.1,14.4
              c0-0.7,0.6-1.3,1.3-1.3c0.7,0,1.3,0.6,1.3,1.3c0,0.7-0.6,1.3-1.3,1.3C9.6,15.8,9.1,15.2,9.1,14.4z M12.3,19.4
              c0,0.2-0.2,0.4-0.4,0.4h-3c-0.2,0-0.4-0.2-0.4-0.4v-2.7c0,0,0-0.1,0.1-0.1h3.6c0.1,0,0.1,0,0.1,0.1L12.3,19.4L12.3,19.4z"/>
          </g>
